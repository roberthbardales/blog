...
26	2022-11-30 16:17:14.097575-05	1	roberthbardales@gmail.com	2	[{"changed": {"fields": ["Nombres"]}}]	6	2
...
6	2022-11-24 20:43:09.750091-05	2022-11-26 21:32:50.546892-05	Django rest framework	Uno de los principales apartados cuando desarrollamos un sistema es la Seguridad, en específico, la denominada Autenticación, la cual no es mas que un conjunto de mecanismos para asociar la solicitud entrante con un conjunto de credenciales de identificación que puede contener el usuario del cual	<p>Uno de los principales apartados cuando desarrollamos un sistema es la Seguridad, en espec&iacute;fico, la denominada Autenticaci&oacute;n, la cual no es mas que un conjunto de mecanismos para asociar la solicitud entrante con un conjunto de credenciales de identificaci&oacute;n que puede contener el usuario del cual proviene la petici&oacute;n o el token perteneciente a un usuario, dependiendo los mecanismos que se hayan definido, se valida si la solicitud puede ser permitida o no.</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>Sabemos que la autenticaci&oacute;n siempre se ejecuta al comienzo de la vista antes de que se produzcan las comprobaciones de permisos y limitaciones y antes de cualquier procesamiento de datos en alguna vista, por ello Django Rest Framework, luego de validar la petici&oacute;n, guardar&aacute; la instancia de la clase User en&nbsp;<em>request.user</em>. Adem&aacute;s de ello, existe otra propiedad llamada request.auth, la cual se utiliza para cualquier informaci&oacute;n adicional de la autenticaci&oacute;n, por ejemplo, representar el Token para la Autenticaci&oacute;n.</p>	t	Entry/Integracion-continua_pIa93xn.jpg	f	t	django-rest-framework-77570	1	2
7	2022-11-25 17:17:57.597974-05	2022-12-07 00:50:41.764817-05	EDITADO VERSION RUNNER	Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?	<pre>\r\n<code>{% extends "base.html" %}\r\n\r\n{% load  static %}\r\n\r\n{% block css %}\r\n&lt;link rel="stylesheet" href="{% static 'css/myblog.css' %}"&gt;\r\n{% endblock css %}\r\n\r\n{% block content %}\r\n{% include "includes/header.html" %}\r\n\r\n\r\n&lt;div class="container border mt-4 mb-4 text-light w-75" style="background-color: rgb(0, 147, 252);"&gt;\r\n    &lt;div class="row  bg-primary px-4 py-4  justify-content-center "&gt;\r\n        &lt;div class="col-12 "&gt;\r\n            &lt;p class="h3 text-center"&gt;Agregar Nuevo Post&lt;/p&gt;\r\n        &lt;/div&gt;\r\n    &lt;/div&gt;\r\n    &lt;form class=" mt-2 mb-2 "  method="POST" enctype="multipart/form-data"&gt;{% csrf_token %}\r\n            &lt;div class="form-row  mb-4 justify-content-center"&gt;\r\n                &lt;div class="col-2"&gt;\r\n                    &lt;p&gt;In Home:&lt;/p&gt;\r\n                    {{form.in_home}}\r\n                &lt;/div&gt;\r\n                &lt;div class="col-2"&gt;\r\n                    &lt;p&gt;Publico:&lt;/p&gt;\r\n                    {{form.public}}\r\n                &lt;/div&gt;\r\n                &lt;div class="col-2"&gt;\r\n                    &lt;p&gt;Portada:&lt;/p&gt;\r\n                    {{form.portada}}\r\n                &lt;/div&gt;\r\n                &lt;div class="col-5"&gt;\r\n                    {{form.tag}}\r\n                &lt;/div&gt;\r\n            &lt;/div&gt;\r\n            \r\n            &lt;div class="form-row justify-content-center"&gt;\r\n                &lt;div class="col-6"&gt;\r\n                    &lt;p&gt;usuario&lt;/p&gt;\r\n                    {{form.user}}\r\n                &lt;/div&gt;\r\n                &lt;div class="col-6"&gt;\r\n                    &lt;p&gt;categoria&lt;/p&gt;\r\n                    {{form.category}}\r\n                &lt;/div&gt;\r\n                    &lt;div class="col-6"&gt;\r\n                        &lt;p&gt;titulo&lt;/p&gt;\r\n                        {{form.title}}\r\n                    &lt;/div&gt;\r\n                    &lt;div class="col-6"&gt;\r\n                        &lt;p&gt;resumen&lt;/p&gt;\r\n                        {{form.resume}}\r\n                    &lt;/div&gt;\r\n                &lt;div class="col-12"&gt;\r\n                    &lt;h5&gt;Contenido&lt;/h5&gt;\r\n                    {{form.media}}\r\n                    {{form.content}}\r\n                &lt;/div&gt;\r\n                &lt;div class="col 12"&gt;\r\n                    &lt;p&gt;Imagen&lt;/p&gt;\r\n                    {{form.image}}\r\n                &lt;/div&gt;\r\n            &lt;/div&gt;\r\n            &lt;div class="form-row"&gt;\r\n                &lt;div class="col-12  mt-4 mb-4 text-center"&gt;\r\n                    &lt;button type="submit" class=" text-white btn btn-success btn-block"&gt;Guardar&lt;/button&gt;\r\n                &lt;/div&gt;\r\n            &lt;/div&gt;\r\n    &lt;/form&gt;\r\n&lt;/div&gt;\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n{% endblock content %}</code></pre>\r\n\r\n<p>&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?<br />\r\n&nbsp;</p>\r\n\r\n<p>&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?<br />\r\n&nbsp;</p>\r\n\r\n<p>&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?<br />\r\n&nbsp;</p>\r\n\r\n<p>&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?<br />\r\n&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?<br />\r\n&nbsp;</p>\r\n\r\n<p>&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?<br />\r\n&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?</p>\r\n\r\n<p>&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?<br />\r\n&nbsp;</p>\r\n\r\n<p>&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?<br />\r\n&nbsp;</p>\r\n\r\n<p>&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?<br />\r\n&nbsp;</p>\r\n\r\n<p>&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?<br />\r\n&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?<br />\r\n&nbsp;</p>\r\n\r\n<p>&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?<br />\r\n&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?</p>\r\n\r\n<p>&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?<br />\r\n&nbsp;</p>\r\n\r\n<p>&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?<br />\r\n&nbsp;</p>\r\n\r\n<p>&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?<br />\r\n&nbsp;</p>\r\n\r\n<p>&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?<br />\r\n&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?<br />\r\n&nbsp;</p>\r\n\r\n<p>&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?<br />\r\n&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?</p>\r\n\r\n<p>&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?<br />\r\n&nbsp;</p>\r\n\r\n<p>&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?<br />\r\n&nbsp;</p>\r\n\r\n<p>&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?<br />\r\n&nbsp;</p>\r\n\r\n<p>&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?<br />\r\n&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?<br />\r\n&nbsp;</p>\r\n\r\n<p>&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?<br />\r\n&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?</p>\r\n\r\n<p>&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?<br />\r\n&nbsp;</p>\r\n\r\n<p>&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?<br />\r\n&nbsp;</p>\r\n\r\n<p>&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?<br />\r\n&nbsp;</p>\r\n\r\n<p>&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?<br />\r\n&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?<br />\r\n&nbsp;</p>\r\n\r\n<p>&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?<br />\r\n&nbsp;Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga ad dolorem, officiis sunt ipsam placeat incidunt labore rerum porro accusamus! Eius amet dignissimos cupiditate quas deserunt dicta laudantium qui accusantium?</p>	t	Entry/desarrolladores-780x470_lZ8aWzX.jpg	f	t	editado-version-runner-3041	1	2
2	2022-11-21 18:01:54.782888-05	2022-11-26 17:59:53.578538-05	Habilidades más demandadas por las empresas internacionales de TI	Para entender los lenguajes de programación y las habilidades tecnológicas que necesitan las empresas y que representan una oportunidad para los desarrolladores mexicanos...	<p>CONTENIDO</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>CONTENIDO</p>\r\n\r\n<p>CONTENIDO</p>\r\n\r\n<p>CONTENIDO</p>\r\n\r\n<p>CONTENIDO</p>\r\n\r\n<p>CONTENIDO</p>	t	Entry/Django-1024x576.2e16d0ba.fill-2000x1000_JlODAtP.jpg	f	t	habilidades-mas-demandadas-por-las-empresas-internacionales-de-ti-64793	1	2
3	2022-11-21 18:02:11.800155-05	2022-11-26 18:00:11.242075-05	Para entender los lenguajes de	Para entender los lenguajes de programación y las habilidades tecnológicas que necesitan las empresas y que representan una oportunidad para los desarrolladores mexicanos...	<p>2</p>	t	Entry/Integracion-continua.jpg	f	t	para-entender-los-lenguajes-de-64811	2	2
5	2022-11-21 18:03:23.641117-05	2022-11-27 17:48:41.889285-05	Habilidades más demandadas por las empresas internacionales de TI	Habilidades Habilidades Habilidades Habilidades	<p>demandadas&nbsp;demandadas&nbsp;demandadas&nbsp;demandadas v</p>	t	Entry/python-lenguaje-de-programacion.jpg	f	t	habilidades-mas-demandadas-por-las-empresas-internacionales-de-ti-64121	1	2
...
34	2022-12-09 21:20:08.949799-05	2022-12-09 21:20:09.126107-05	gh	gh	<p>ghghghgh</p>	t	Entry/registro-y-autenticacion-con-dja.2e16d0ba.fill-2000x1000_jyWMENr.jpg	f	t	gh-76809	3	2
\.
...
60	2022-11-30 22:38:28.620676-05	2022-11-30 22:38:28.620676-05	6	1
61	2022-11-30 22:38:32.699564-05	2022-11-30 22:38:32.699564-05	5	1
62	2022-11-30 22:40:46.463944-05	2022-11-30 22:40:46.463944-05	7	1
...
2	pbkdf2_sha256$180000$rkrUfCWoVSDI$CPOTy8NwIkx+Nua/IQqBTNyTszSVF1HvNpyVZFnSPic=	2022-12-01 17:11:06-05	t	neunapp@gmail.com	neunapp			\N	t	t
