...
5	pbkdf2_sha256$180000$LLib7UK2ksGZ$hECIGnmnbpMRMw2atEGBfomKSyHPP6g24hpb6P+O6WA=	2023-01-17 16:36:35.970352-05	f	prueba1@gmail.com	prueba1	1	M	2000-01-01	t	t
1	pbkdf2_sha256$180000$Wpx4o2SJQnr2$UoLki72vpmcXBqFcjGySK+ZA3mECelzsS2LN38fA+7A=	2023-01-17 17:25:03.850116-05	t	roberthbardales@gmail.com	Russell Bardales	0	M	1995-01-08	t	t
\.
...
SELECT pg_catalog.setval('public.entrada_category_id_seq', 14, true);
...
SELECT pg_catalog.setval('public.entrada_entry_id_seq', 119, true);
...
SELECT pg_catalog.setval('public.entrada_entry_tag_id_seq', 121, true);
...
SELECT pg_catalog.setval('public.home_contact_id_seq', 7, true);
...
SELECT pg_catalog.setval('public.home_suscribers_id_seq', 11, true);
